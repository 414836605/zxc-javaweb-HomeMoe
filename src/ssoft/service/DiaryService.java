...
public interface DiaryService extends Service {
	 ...
	 * @return
	 */
	String getGroupDiary(String id, String password, String groupId);
	 ...
	 * @return
	 */
	String getOfficialaccountDiary(String id, String password, String officialId,String start,String offset);
	 ...
	 * @return
	 */
	String getDiaryRemark(String id, String password, String diaryId);
	 ...
	 * @return
	 */
	String getFriendCircleDiary(String id, String password, String start, String offset);
